...
const SuccessStoriesScreen = ({navigation}) => {
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: colors.background}}>
      <StatusBar barStyle="light-content" backgroundColor="#0b25b7ff" />
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        >
              ...
              return (
                <View key={story.id} style={[
                  ...
                  <View style={styles.userInfo}>
                    ...
                    />
                    <View style={styles.userDetails}>
                      <Text style={[styles.userName, { color: colors.text }]}>{story.name}</Text>
                      <Text style={[styles.userRole, { color: colors.primary }]}>{story.role}</Text>
                      <Text style={[styles.userCompany, { color: colors.textSecondary }]}>{story.company}</Text>
                    </View>
                    <Icon name="quote-left" size={20} color={colors.border} style={styles.quoteIcon} />
                  </View>

                  <Text style={[styles.storyQuote, { color: colors.textSecondary }]}>
                    "{story.quote}"
                  </Text>

                  <View style={[styles.storyStats, { borderTopColor: colors.border }]}>
                    <View style={styles.statRow}>
                      <MaterialIcons name="visibility" size={16} color="#3498db" />
                  ...
                  <View style={styles.actionButtons}>
                    <TouchableOpacity 
                      style={[
                        styles.likeButton,
                        { backgroundColor: isDark ? colors.backgroundSecondary : '#ffeaea' },
                        isLiked && [
                          styles.likeButtonActive, 
                          { 
                            backgroundColor: isDark ? '#2c1818' : '#ffd1d1',
                            borderColor: '#e74c3c'
                          }
                        ]
                      ]}
                    ...
                    >
                      ...
                      <Text style={[
                        styles.buttonText,
                        { color: colors.text },
                        isLiked && [styles.buttonTextActive, { color: '#e74c3c' }]
                      ]}>
                        Inspire {inspireCount > 0 && `(${inspireCount})`}
                      </Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity 
                      style={[
                        styles.shareButton, 
                        { backgroundColor: isDark ? colors.backgroundSecondary : '#eaf2f8' }
                      ]}
                      onPress={() => handleShare(story)}
                    >
                      <Icon name="share" size={16} color="#3498db" />
          ...
          <View style={styles.footer}>
            <LinearGradient
              colors={isDark ? [colors.backgroundSecondary, colors.background] : ['#ffecd2', '#fcb69f']}
              style={[styles.footerGradient, {
                shadowColor: isDark ? '#000' : '#000',

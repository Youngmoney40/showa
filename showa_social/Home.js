...
// // //   videoThumbnaislContainer: {
// // //     flex: 1,
// // //     backgroundColor: '#000',
// // //     position: 'relative',
// // //   },
// // //   videoLoadissngOverlay: {
...
// // // // Handle navigation events and back button to pause videos
// // // useEffect(() => {
...
// // //     console.log('Screen blurred - pausing videos');
// // //     pauseAllVideos();
// // //   });

// // //   const unsubscribeBeforeRemove = navigation.addListener('beforeRemove', () => {
// // //     console.log('Screen being removed - pausing videos');
// // //     pauseAllVideos();
// // //   });

// // //   const unsubscribeFocus = navigation.addListener('focus', () => {
// // //     console.log('Screen focused - resuming current video');
// // //     // Resume only the current video
// // //     if (filteredShorts.length > 0 && currentIndex !== undefined) {
...
// // //     // Force pause all videos on unmount
// // //     if (filteredShorts.length > 0) {
// // //       const pausedState = {};
// // //       filteredShorts.forEach((_, index) => {
// // //         pausedState[index] = true;
...
// // // // Manual function to pause all videos (can be called from anywhere)
...
// //   // Force MP4 format and lowest quality for instant start
// //   return videoUrl
// //     .replace('/upload/', '/upload/f_mp4,q_auto:low,fl_animated,fl_progressive/')
// //     .replace(/\.[^/.]+$/, '.mp4'); // Force .mp4 extension
// // };

// // // OPTIMIZATION 2: Pre-generate thumbnail at exact dimensions
// // // const getVideoThumbnail = (videoUrl) => {
// // //   if (!videoUrl) return null;
// // //   if (videoUrl.includes('cloudinary')) {
// // //     return videoUrl.replace('/video/upload/', '/video/upload/w_${width},h_${height},c_fill,f_auto,q_auto/');
// // //   }
// // //   return null;
// // // };
...
// // // const getVideoThumbnail = (videoUrl) => {
// // //   // Return a placeholder for now - fix Cloudinary later
// // //   return 'https://t4.ftcdn.net/jpg/02/08/22/01/360_F_208220198_yaYA9PcS4C92chHmWQ32Tjry89iO9Quy.jpg';
// // // };
...
// // // OPTIMIZATION 3: Preload component that silently loads videos
...
// //       playWhenInactive={false}
// //       bufferConfig={{
// //         minBufferMs: 0, // Start playing immediately
// //         maxBufferMs: 2000,
// //         bufferForPlaybackMs: 0, // Don't wait for buffer
...
// //   const preloadPromises = shorts.map(short => {
// //     if (short.video) {
// //       const thumbnailUrl = getVideoThumbnail(short.video);
// //       if (thumbnailUrl) {
// //         return Image.prefetch(thumbnailUrl)
// //           .then(success => {
// //             if (success) {
// //               console.log('✅ Preloaded:', thumbnailUrl);
// //             } else {
// //               console.log('⚠️ Using placeholder for:', short.id);
// //             }
// //           })
// //           .catch(() => {
// //             console.log('⚠️ Preload failed, will use placeholder');
// //           });
// //       }
// //     }
...
// //   // OPTIMIZATION 5: Preload next videos instantly
// //   const preloadNextVideos = useCallback((startIndex) => {
// //     const videosToPreload = filteredShorts.slice(
// //       startIndex + 1,
// //       startIndex + 4 // Preload next 3 videos
// //     );
    
// //     videosToPreload.forEach(video => {
// //       if (video?.video && !preloadedVideos[video.id]) {
// //         // Use Image for thumbnail preload
...
// //       // Preload next videos when current changes
// //       preloadNextVideos(newIndex);
// //     }
// //   }).current;

// //   const viewabilityConfig = useRef({
// //     itemVisiblePercentThreshold: 10, // Lower threshold for faster activation
// //   }).current;


// //   const renderNavBar = () => (
// //     <SafeAreaView style={[styles.navBar,{flex:1}]}>
// //     <View style={[
// //       styles.navBar,
// //       Platform.OS === 'ios' && styles.navBarIOS
// //     ]}>
...
// //   setLoadingShorts(true);
// //   try {
// //     // FIRST: Try to get cached videos (instant!)
...
// //       console.log('Full API Responsesssss:', JSON.stringify(response.data, null, 2));
...
// //         // ✅ Update cache with fresh videos
// //         await setCachedShorts(processedShorts);
        
// //         // ✅ Trigger background prefetch for next videos (AFTER setting state)
// //         setTimeout(() => {
...
// //   const isPaused = pausedVideos[index] || false;
// //   const isBuffered = bufferedVideos[item.id] || false;
// //   const isMuted = mutedVideos[item.id] || false; // Get mute state from parent
...
// //      <ProgressiveVideo
// //       uri={getOptimizedVideoUrl(item.video)}
// //       videoId={item.id} // Pass video ID for cache lookup
...
// //       {/* Hidden preloaders for next videos */}
...
// //           >
// //             <Ionicons name="arrow-redo" size={36} color="#fff" />
// //              {/* <Text style={styles.countText}>{item.Share_count || 0}</Text> */}
// //             <Text style={styles.countText}>Share</Text>
// //           </TouchableOpacity>
...
// //     </TouchableOpacity>
// //   );
// // }, [currentIndex, pausedVideos, activeTab, bufferedVideos, filteredShorts, mutedVideos]); 
...
// // ============ FIXED: Render NavBar with SafeAreaView ============
// const renderNavBar = () => (

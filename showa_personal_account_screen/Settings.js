...
//     { label: 'Sign Out', icon: 'log-out-outline', isLogout: true },
...
//               <Text style={[styles.contactPhone, { color: colors.textSecondary || colors.text }]}>{userData.phone}</Text>
//             </View>
//           </View>
//         )}
...
const ContactProfile = ({ navigation }) => {
  ...
  const showDifferenceExplanation = () => {
    Alert.alert(
      'Sign Out vs Delete Account',
      'SIGN OUT:\n• Temporarily logs you out\n• Your account and all data remain intact\n• You can log back in anytime\n• All your messages, contacts, and content are saved\n\nDELETE ACCOUNT:\n• Permanently removes your account\n• All your data is erased\n• Cannot be recovered\n• You will lose all messages, contacts, and content\n\nAre you sure you want to proceed?',
      [
        { text: 'Cancel', style: 'cancel' },
        { text: 'Sign Out', onPress: handleSignOut, style: 'default' },
            ...
            {menuItems.map(({ label, icon, isLogout, isTheme, isSignOut, isDelete }) => (
              ...
              >
                <View style={styles.menuItemLeft}>
                  <View style={[
                    dynamicStyles.iconWrapper, 
                    isSignOut && styles.signOutIconBackground,
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: colors.surface }]}>
            ...
            <Text style={[styles.modalDescription, { color: colors.textSecondary }]}>
              Signing out will temporarily log you out of your account. You can log back in anytime with your credentials.
            </Text>
            ...
            <View style={styles.modalButtons}>
              ...
              <TouchableOpacity
                style={[styles.modalButton, styles.signOutButton, { backgroundColor: '#ff9800' }]}

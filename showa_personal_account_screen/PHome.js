...
// //         console.log('App came to foreground, refreshing notification count bhgghh');
// //         fetchUnreadNotificationCount();
// //         // Also refresh chat list to get latest updates
...
// Initialize MMKV instances for cachingh
const personalChatStorage = createMMKV({
  id: 'personal-chats-cache'
});
...
const PersonalChatHomeScreen = ({ navigation, route }) => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.backgroundSecondary }]}>
      ...
      {/* <IncomingCallHandler navigation={navigation} route={routehh} /> */}

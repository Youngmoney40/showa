...
//                 onPress={() => {
//                   console.log('Delete button pressed on IOS', item); 
...
//       >
//         <SafeAreaView style={{ flex: 1, backgroundColor: colors.background, marginTop:20 }}>
...
//   deleteModalContent: {
//   backgroundColor: colors.background,
//   borderRadius: 14, // Slightly more rounded for iOS
//   padding: 24,
//   width: '85%',
//   maxWidth: 340,
//   ...Platform.select({
...
// },
// deleteModalTitle: {
//   fontSize: 20, // Slightly larger for iOS
//   fontWeight: '600',
//   marginBottom: 8,
//   color: colors.text,
//   textAlign: 'center',
...
//   deleteModalButtons: {
//   flexDirection: 'row',
//   justifyContent: 'space-around', // Better spacing on iOS
// },
//   deleteModalButton: {
//     paddingHorizontal: 16,
//     paddingVertical: 8,
  ...
  try {
    ...
    statuses.forEach(userStatus => {
      userStatus.statuses.forEach(status => {
        ...
        // For videos, you might want to cache them differently
      });
    });

...
//   // Post is trending if:
//   // 1. Posted within last 24 hours
//   // 2. Has at least 50 views
//   // 3. Engagement rate > 10%
...
//   const shareWeight = 5;     // Shares show high engagement
//   const viewWeight = 0.1;    // Views are less valuable per unit
...
//   }, [post.like_count, post.reactions]);
...
//           <Text style={[styles.networkScore, { color: colors.primary }]}>
//             {networkScore}
//           </Text>
...
//         </View>
//         {/* {viralStatus && (
//           <View style={[styles.networkStatus, { backgroundColor: viralStatus.color }]}>
//             <Text style={styles.networkStatusText}>{viralStatus.emoji}</Text>
//           </View>
//         )} */}
...
// const NetworkDetailsModal = ({ visible, onClose, post, networkScore, viralStatus, colors }) => {
//   const reactions = [
//     { 
//       icon: 'heart', 
//       label: 'Likes', 
...
//       color: '#ED4956',
//       percentage: post.views > 0 ? Math.round(((post.like_count || 0) / post.views) * 100) : 0,
//       description: 'People who enjoyed this post'
//     },
//     { 
//       icon: 'chatbubble', 
//       label: 'Comments', 
...
//       color: '#2196F3',
//       percentage: post.views > 0 ? Math.round(((post.comment_count || 0) / post.views) * 100) : 0,
//       description: 'Conversations started by this post'
//     },
//     { 
//       icon: 'share-social', 
//       label: 'Shares', 
...
//       color: '#4CAF50',
//       percentage: post.views > 0 ? Math.round(((post.share_count || 0) / post.views) * 100) : 0,
//       description: 'How far this post traveled'
//     },
//     { 
//       icon: 'eye', 
//       label: 'Views', 
...
//       color: '#9E9E9E',
//       percentage: 100,
//       description: 'Total people who saw this post'
//     },
//   ];
...
//   const getInsights = () => {
//     const insights = [];
//     const likeRate = post.views > 0 ? ((post.like_count || 0) / post.views) * 100 : 0;
//     const commentRate = post.views > 0 ? ((post.comment_count || 0) / post.views) * 100 : 0;
//     const shareRate = post.views > 0 ? ((post.share_count || 0) / post.views) * 100 : 0;

//     if (likeRate > 20) insights.push('👍 High like rate - people love this!');
//     if (commentRate > 5) insights.push('💬 Great discussion happening here!');
//     if (shareRate > 3) insights.push('📤 This post is going viral!');
//     if (post.views > 1000) insights.push('👀 Reached over 1000 people!');
//     if (post.comment_count > 50) insights.push('🔥 Hot topic - lots of engagement!');
//     if (post.share_count > 20) insights.push('🚀 People are sharing this everywhere!');
...
//                   Post Network
//                 </Text>
//                 <TouchableOpacity onPress={onClose} style={styles.networkModalClose}>
//                   <Ionicons name="close" size={24} color={colors.text} />
//                 </TouchableOpacity>
//               </View>

//               {/* Network Score */}
//               <View style={[styles.networkScoreContainer, { backgroundColor: colors.backgroundSecondary }]}>
//                 <View style={styles.networkScoreCircle}>
//                   <Text style={[styles.networkScoreNumber, { color: colors.primary }]}>
//                     {networkScore}
//                   </Text>
//                   <Text style={[styles.networkScoreLabel, { color: colors.textSecondary }]}>
//                     Network Score
//                   </Text>
//                 </View>
//                 <View style={styles.networkStatusBadge}>
//                   <Text style={styles.networkStatusEmoji}>{viralStatus.emoji}</Text>
//                   <Text style={[styles.networkStatusLabel, { color: viralStatus.color }]}>
//                     {viralStatus.label}
//                   </Text>
//                 </View>
//               </View>
...
//               {/* Reactions Breakdown */}
//               <ScrollView style={styles.networkReactionsList} showsVerticalScrollIndicator={false}>
//                 {reactions.map((reaction, index) => (
//                   <View key={index} style={[styles.networkReactionItem, { borderBottomColor: colors.border }]}>
//                     <View style={styles.networkReactionHeader}>
//                       <View style={styles.networkReactionIconContainer}>
//                         <Ionicons name={reaction.icon} size={22} color={reaction.color} />
//                       </View>
//                       <View style={styles.networkReactionInfo}>
//                         <Text style={[styles.networkReactionLabel, { color: colors.text }]}>
//                           {reaction.label}
//                         </Text>
//                         <Text style={[styles.networkReactionDescription, { color: colors.textSecondary }]}>
//                           {reaction.description}
//                         </Text>
//                       </View>
//                       <View style={styles.networkReactionCount}>
//                         <Text style={[styles.networkReactionNumber, { color: colors.text }]}>
//                           {reaction.count}
//                         </Text>
//                         {reaction.percentage > 0 && (
//                           <Text style={[styles.networkReactionPercentage, { color: colors.textSecondary }]}>
//                             {reaction.percentage}%
//                           </Text>
//                         )}
//                       </View>
...
//                     {/* Progress Bar */}
//                     <View style={styles.networkProgressBar}>
//                       <View 
//                         style={[
//                           styles.networkProgressFill, 
//                           { 
//                             width: `${Math.min(reaction.percentage, 100)}%`,
...
//                 {/* Insights Section */}
//                 {insights.length > 0 && (
//                   <View style={styles.networkInsightsContainer}>
//                     <Text style={[styles.networkInsightsTitle, { color: colors.text }]}>
//                       💡 Insights
//                     </Text>
//                     {insights.map((insight, index) => (
//                       <View key={index} style={[styles.networkInsightItem, { backgroundColor: colors.backgroundSecondary }]}>
//                         <Text style={[styles.networkInsightText, { color: colors.text }]}>
//                           {insight}
//                         </Text>
//                       </View>
//                     ))}
...
//                 {/* Share Network Score */}
//                 <TouchableOpacity 
//                   style={[styles.networkShareButton, { backgroundColor: colors.primary }]}
//                   onPress={() => {
//                     // Share network score
//                     Share.share({
//                       message: `🎉 My post network score is ${networkScore}! ${viralStatus.emoji}\nCheck it out on Showa!`,
//                     });
//                   }}
//                 >
//                   <Text style={styles.networkShareButtonText}>
//                     📤 Share Network Score
//                   </Text>
//                 </TouchableOpacity>
...
//         {(localLikeCount > 0 || post.comment_count > 0 || post.views > 0) && (
...
//     {/* Spacer to push network button to the right */}
//     <View style={styles.actionSpacer} />
    
//     {/* Network Button - Separate from others */}
//     <TouchableOpacity
//       style={styles.networkActionButton}
//       onPress={() => setShowNetworkModal(true)}
//       activeOpacity={0.7}
//     >
//       <View style={styles.networkActionContent}>
...
//         </View>
//         {networkScore > 0 && (
//           <Text style={[styles.networkActionScore, { color: colors.textSecondary }]}>
//             {networkScore}
//           </Text>
//         )}
...
//     // If we're reacting, don't sync with props
//     if (isReacting) return;
    
//     // Otherwise, sync normally
//     setLocalLikeCount(post.like_count || 0);
//     setLocalIsLiked(post.reactions?.user_reaction === 'like');
//   }, [post.like_count, post.reactions, isReacting]);

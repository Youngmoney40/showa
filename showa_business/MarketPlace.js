...
//                   [getCategoryColor(category), lightenColor(getCategoryColor(category), 20)]}
//                 style={[
//                   styles.categoryIcon,
...
//               >
//                 <FontAwesome 
//                   name={category === 'All' ? 'th' : getCategoryIcon(category)} 
//                   size={20} 
//                   color="#fff" 
//                 />
//               </LinearGradient>
      ...
      >
        ...
        <View style={styles.promoContainer}>
          ...
          <View style={styles.promoContent}>
            <Text style={styles.promoTitle}>Summer Sale</Text>
            <Text style={styles.promoSubtitle}>Up to 50% off</Text>
            <TouchableOpacity style={[styles.promoButton, { backgroundColor: colors.card }]} activeOpacity={0.7}>
              <Text style={[styles.promoButtonText, { color: colors.primary }]}>Shop Now</Text>
            </TouchableOpacity>
          </View>
          <View style={styles.bannerIndicators}>

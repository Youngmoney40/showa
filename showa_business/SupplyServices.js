  ...
  const renderItem = ({ item }) => (
    ...
    >
      ...
      <View style={styles.contractActions}>
        ...
        <Text style={styles.applicantsText}>{item.applicants}</Text>
      </View>
    </TouchableOpacity>
  );
      ...
      <View style={styles.header}>
        <View style={styles.navBarDetails}>
            <TouchableOpacity onPress={()=>navigation.goBack()}>
                 <Ionicons style={{marginRight:10}} name="arrow-back" size={24} color="#333" />
        ...
        <TouchableOpacity style={{ backgroundColor:'#4A00E0', borderRadius:50, padding:4}} onPress={()=>navigation.navigate('CreateServices')}>

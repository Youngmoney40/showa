  ...
  const handleReportUser = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API_ROUTE}/report-user/`,
        {
          reported_user_id: userIdFromParams,
          reason: reportReason,
        },
        {
          headers: { Authorization: `Bearer ${token}` },
      ...
      >
        ...
        >
          <View style={[styles.optionsModalContent, { backgroundColor: colors.card }]}>
            ...
            >
              <Icon name="ban-outline" size={24} color="#ff5c5c" />
              <Text style={[styles.optionText, { color: '#ff5c5c' }]}>
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.reportModalContent, { backgroundColor: colors.card }]}>
            ...
            <Text style={[styles.reportModalDescription, { color: colors.textSecondary }]}>
              Please tell us why you're reporting {profileData.user?.name}. This helps us keep the community safe.
            </Text>
            
            <TextInput
              style={[styles.reportInput, { backgroundColor: colors.backgroundSecondary, color: colors.text }]}
            ...
            <View style={styles.reportModalButtons}>
              ...
              <TouchableOpacity
                style={[styles.reportButton, styles.submitReportButton, { backgroundColor: '#ff9800' }]}
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.blockModalContent, { backgroundColor: colors.card }]}>
            <View style={styles.blockModalHeader}>
              ...
              <Text style={[styles.blockModalTitle, { color: colors.text }]}>Block User</Text>
            </View>
            
            <Text style={[styles.blockModalDescription, { color: colors.textSecondary }]}>
              Are you sure you want to block {profileData.user?.name}?
            </Text>
            
            <Text style={[styles.blockModalWarning, { color: '#ff5c5c' }]}>
              • They will no longer be able to message you
              • They won't be able to see your posts or stories
              • You won't see their content either
            </Text>
            
            <View style={styles.blockModalButtons}>
              <TouchableOpacity
                style={[styles.blockButton, styles.cancelBlockButton, { backgroundColor: colors.surfaceVariant }]}
                onPress={() => setBlockModalVisible(false)}
              >
                <Text style={[styles.cancelButtonText, { color: colors.text }]}>Cancel</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.blockButton, styles.confirmBlockButton, { backgroundColor: '#ff5c5c' }]}
